<template>
    <section class="article-intro-block">
        <div class="article-intro-block__wrapper">
            <div class="article-intro-block__image-wrapper">
                <img
                    :src="componentData.data.image"
                    alt="Изображение фона article-intro-block"
                    class="article-intro-block__image"
                >
            </div>
            <div class="article-intro-block__content">
                <h2 class="article-intro-block__title">
                ...
                <p class="article-intro-block__desc">

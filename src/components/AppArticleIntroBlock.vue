<template>
    <section class="article_intro_block">
        <div class="article_intro_block__wrapper">
            <div class="article_intro_block__image-wrapper">
                <img
                    :src="componentData.data.image"
                    alt="Изображение фона article-hero"
                    class="article_intro_block__image"
                >
            </div>
            <div class="article_intro_block__content">
                <h2 class="article_intro_block__title">
                    {{ componentData.data.title }}
                </h2>
                <div class="article_intro_block__statistic">
                    <p class="article_intro_block__statistic-item">
                        ...
                        <span>
                            {{ componentData.data['reading_time'] }} мин время чтения
                        </span>
                    </p>
                    <p class="article_intro_block__statistic-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        ...
                        <span>
                            {{ componentData.data['views_count'] }} прочитали статью
                        </span>
                    </p>
                </div>
                <p class="article_intro_block__desc">
                    {{ componentData.data['short_description'] }}
                </p>
            </div>
        </div>
    </section>

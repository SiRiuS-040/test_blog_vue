<template>
    <section class="article-text-block">
        ...
        >
            <div
                v-html="componentData.data"
            />

<!--            <h2 class="app-article__title">-->
<!--                {{ componentData.data.title}}-->
<!--            </h2>-->
<!--            <div class="article-text-block__content-wrapper">-->
<!--                <p class="article-text-block__text">-->
...
<!--                    </p>-->
<!--                    <p class="article-quote__sign-name">-->
<!--                        Ярослав Кравцов,-->
<!--                    </p>-->
<!--                    <p class="article-quote__sign-info">-->
<!--                        основатель студии «Мастерская 15»-->
<!--                    </p>-->
<!--                </div>-->
<!--            </div>-->
        </div>
